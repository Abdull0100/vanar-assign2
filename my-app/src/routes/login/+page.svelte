    ...
    <div class="bg-white py-8 px-6 shadow-lg rounded-lg border border-gray-200">
      ...
      <div class="mt-6">
        ...
        <div class="mt-6 space-y-3">
          <a 
            href="/auth/google" 
            class="w-full inline-flex justify-center items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors"
          >
