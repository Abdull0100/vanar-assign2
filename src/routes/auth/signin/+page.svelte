				...
				<form class="grid gap-4" on:submit|preventDefault={handleCredentialsSignIn}>
					<div class="grid gap-2">
						...
						<input
							...
							required
							bind:value={email}
							class="h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
						/>
					</div>
					<div class="grid gap-2">
						<div class="flex items-center">
							<label for="password" class="text-sm font-medium">Password</label>
							<a href="/auth/forgot-password" class="ml-auto inline-block text-xs underline text-muted-foreground hover:text-foreground">
