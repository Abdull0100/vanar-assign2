		...
		<div class="rounded-lg border border-border bg-card shadow-sm">
			<div class="px-6 pt-6">
				...
				<p class="mt-1 text-sm text-muted-foreground">
					Or <a href="/auth/signin" class="text-primary hover:underline"
			...
			<div class="px-6 py-6">
				...
				{#if success}
					<div
						class="mb-4 rounded-md border border-green-300 bg-green-100 px-4 py-3 text-sm text-green-900"
					>
						Account created successfully! Please check your email for verification. Redirecting to
						verification page...
					</div>
				{/if}
