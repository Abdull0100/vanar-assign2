...
<div class="mt-8">
	<h2 class="mb-6 text-2xl font-bold">System Overview</h2>
	<div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
		<Card.Root class="border bg-card text-card-foreground">
			...
			<Card.Content class="p-6">
				<div class="flex items-center">
					...
					<div class="ml-4">
						...
						<div
							class="text-lg font-bold {localStats.systemStatus === 'online'
								? 'text-primary'
								: 'text-destructive'}"
						>
							{#if isLoading}
